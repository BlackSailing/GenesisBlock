...
def create_block_header(hash_merkle_root, time, bits, nonce):
  ...
  genesisblock.hash_prev_block  = struct.pack('<32x')
...
def generate_hashes_from_block(data_block, algorithm):
    ...
    if algorithm == 'scrypt':
        ...
        import xcoin_hash as hashing_module
        header_hash = hashing_module.getPoWHash(data_block)[::-1]
    elif algorithm == 'X13':
        import x13_hash as hashing_module
        header_hash = hashing_module.getPoWHash(data_block)[::-1]
    elif algorithm == 'X15':
        import x15_hash as hashing_module
        header_hash = hashing_module.getPowHash(data_block)[::-1]
...
def print_block_info(options, hash_merkle_root):
  ...
  print("merkle hash: "  + binascii.hexlify(hash_merkle_root[::-1]).decode('utf-8'))
